...
export default function HeroSection() {
  return (
    <section className="relative h-screen flex flex-col" style={{ overflowX: 'clip' }}>
      ...
      <div className="relative flex-1 flex flex-col justify-end">
        ...
        <div className="relative z-20 flex items-end justify-between px-6 md:px-10 pb-7 sm:pb-8 md:pb-10">
          <FadeIn delay={0.35} y={20}>
            ...
            >
              a web designer, ceo &amp; forex trader driven by building bold digital experiences
            </p>
          </FadeIn>
      ...
      {/* Outer element owns the centering transform; FadeIn's own motion
          transform is isolated on the inner wrapper so the two don't fight
          over the CSS `transform` property. */}
