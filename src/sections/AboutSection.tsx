    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 sm:gap-14 md:gap-16">
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
          <AnimatedText
            text="I'm Abdellah Guerifi -- a web designer building with vibecoding, a ceo, and a forex trader and expert. I'm also a media personality and tech presenter, sharing what i learn across design, business, and markets. I truly enjoy working with businesses and creators that aim to stand out and present their best image. Let's build something incredible together!"
